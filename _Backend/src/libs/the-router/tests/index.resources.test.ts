...
import { resources, getRouter, setActionsPath, resetRouter, routeScope as scope } from '../index';
...
describe('Resource Routes', () => {
  ...
  test('should create update routes (PUT and PATCH)', async () => {
    ...
    const patchResponse = await request(app).patch('/posts/123').send(updateData);
